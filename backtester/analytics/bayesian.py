...
def plot_best(trace=None, data_train=None, data_test=None, samples=1000, burn=200, axs=None):
...
def run_model(model, returns_train, returns_test=None, bmark=None, samples=500, ppc=False):
