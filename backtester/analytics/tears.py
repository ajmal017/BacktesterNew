...
@plotting_context
def create_position_tear_sheet(returns, positions, gross_lev=None, show_and_plot_top_pos=2, hide_positions=False,
...
@plotting_context
def create_txn_tear_sheet(returns, positions, transactions, unadjusted_returns=None, return_fig=False):
    """
...
@plotting_context
def create_round_trip_tear_sheet(positions, transactions, sector_mappings=None, return_fig=False):
    """
