...
def plot_rolling_fama_french(returns, factor_returns=None, rolling_window=APPROX_BDAYS_PER_MONTH * 6, legend_loc='best',
                             ax=None, **kwargs):
...
def plot_slippage_sweep(returns, transactions, positions, slippage_params=(3, 8, 10, 12, 15, 20, 50), ax=None, **kwargs):
...
def plot_slippage_sensitivity(returns, transactions, positions, ax=None, **kwargs):
